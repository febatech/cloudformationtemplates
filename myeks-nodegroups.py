...
vpc_name = cluster_name + "-vpc2"
workers_name = cluster_name + "-workers"
netapp_stack='netapp-ontap-stack'

# CloudFormation templates for VPC and worker nodes
vpc_template = "https://myeksfiles.s3.ap-south-1.amazonaws.com/vpc-2public-2private-subnets.yaml"
...
if stack_exists(cf, netapp_stack):
    ...
    print("Created stack " + netapp_stack)
...
if stack_exists(cf, workers_name):
    ...
    try:
        # This is a watcher which waits for the stack deployment to complete.
